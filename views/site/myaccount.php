        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="con-text">
                    ...
                    <p><a href="<?=Url::home()?>">Главная</a> | Мой профиль</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingOne">
                                <h4 class="panel-title">
                                    <a class="collapsed method" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Редактировать личные данные <i class="fa fa-caret-down"></i></a>
                                </h4>
                            </div>
